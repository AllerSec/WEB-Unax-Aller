const eu = {
  nav: {
    ...
    contacto: "Kontaktua",
    consultaGratuita: "Nire weba nahi dut",
  },
  hero: {
    title: "Dei gehiago zure tokiko negoziorako. 1.300€.",
    subtitle:
      "Zure web profesionala, zure Google Maps fitxa optimizatua eta iritziak biltzeko sistema. Ordainketa bakarra, lehen urtea barne. 30 eguneko itzulketa bermea.",
    subtitlePre:
      "Zure web profesionala, zure Google Maps fitxa eta iritzien sistema, ordainketa bakarrean: ",
    subtitlePost: " + BEZ, lehen urtea barne.",
  ...
  services: {
    title: "Tiket altuko negozio profesionalentzat pentsatua.",
    subtitle:
      "Klinikak, bulego profesionalak, B2B industria, inmobiliariak, merkataritza premium. Zure bezeroak online konparatzen badu telefonoa hartu aurretik, sistema hau zuretzat da.",
    localBusiness: {
      title: "Hortz-klinikak, fisio, estetika",
      description:
        "Pazienteek 3 klinika konparatzen dituzte hitzordu eskatu aurretik. Webak konfiantza transmititu behar du: taldearen eta lokalaren argazki errealak, zerbitzu eta prezio argi, iritzi ikusgaiak, hitzordu erraza.",
    },
    clinic: {
      title: "Bulego profesionalak eta aholkularitzak",
      description:
        "Abokatuak, gestoriak, kontsultoriak, ingeniaritzak. Tiket altuko zerbitzuak, bezeroak telefonoa hartu aurretik online konparatzen dituenak. Web serioa, jardun-eremu argiak, taldea ikusgai eta leadak iragazten dituen formularioa.",
    },
    multilingual: {
      title: "Industria eta zerbitzu tekniko B2B",
      description:
        "Euskal Herriko eta Nafarroako poligonoetako industria txikiak eta B2B hornitzaileak. Erosketa erabakitzen duenak gauez katalogoak konparatzen ditu mugikorretik. Gaitasun teknikoa transmititzen duen web serioa, zerbitzuen atal argia, ziurtagiri ikusgaiak eta benetan merezi dutenak iragazten dituen kotizazio-formularioa behar dituzu.",
    },
    redesign: {
      title: "Inmobiliariak eta sektore premium",
      description:
        "Inmobiliariak, tokiko aseguruak, optika, bitxidenda, dekorazioa. Tiket altuko profesionalak, marka eta tokiko hurbiltasuna baliabide nagusia direnean. Seriotasuna transmititzen duen weba, listing eguneratuak eta lead-en harrapaketa kualifikatua.",
    },
    cta: "Plan osoa ikusi",
  ...
  homeProcess: {
    ...
    title: "Hutsetik dei gehiagora 4 urratsetan.",
    steps: [
      { number: "01", title: "Proposamen bat erakusten dizut", desc: "Ezer sinatu aurretik, proposamen bat bidaltzen dizut zure webgunea nolakoa izango litzatekeen ikusteko: egitura, diseinua eta planteamendua. Ez bazaizu gustatzen, horretan geratzen da eta ez didazu ezer zor." },
      { number: "02", title: "Zure gustura egokitzen dugu", desc: "Tipografia, koloreak eta maketa errealak. WhatsApp bidez aurrerapenak bidaltzen dizkizut eta zure gustura egokitzen dugu." },
      { number: "03", title: "Zure weba argitaratzen dugu", desc: "1.300€ + BEZ ordainketa bakarra, lehen urteko mantentze-lana barne. 30 eguneko itzulketa-bermea. Weba zurea da, hileko kuotarik gabe." },
      { number: "04", title: "Lehen urteko aldaketak", desc: "Testuak, argazkiak, prezioak, ordutegia, zerbitzu berri bat… WhatsApp bidez idazten didazu eta nik egiten dut. Formulariorik gabe, tiketik gabe, faktura gehigarririk gabe." },
    ],
  ...
  pricing: {
    title: "Zure weba: 1.300€, lehen urtea barne",
    subtitle:
      "Ordainketa bakarra, gehi BEZ. Lehen urteko mantentze-lana barne. 30 eguneko bermea. Weba zurea da.",
    from: "Ordainketa bakarra",
    month: "+ BEZ",
    popular: "1. urtea barne",
    cta: "Nire weba nahi dut",
    ctaContact: "Auditoria eskatu",
    notePrice:
      "Ordainketa bakarra, lehen urteko mantentze-lana barne. 2. urtetik aurrera, 600€/urteko (50€/hilean inguru, urtean behin fakturatua) sarean eta zainduta edukitzeko. Domeinua zurea da lehen egunetik.",
    plans: [
      {
        name: "Zure weba, eginda",
        subtitle: "Ordainketa bakarra, lehen urtea konponduta",
        price: "1.300€",
        description:
          "Ordainketa bakarra + BEZ, lehen urteko mantentze-lana barne. 30 eguneko itzulketa bermea. Dena: diseinua, hostinga, domeinua, Google Maps, iritziak eta WhatsApp laguntza. Weba zurea da, hileko kuotarik gabe.",
        features: [
          ...
          "Domeinua, hostinga, laguntza eta aldaketak barne lehen urtean",
        ],
      },
    ],
  },
  ...
  footer: {
    tagline: "Non estetikak funtzioarekin bat egiten duen.",
    links: {
      company: "Enpresa",
      services: "Zerbitzuak",
      legal: "Legala",
  ...
  notFound: {
    ...
    subtitle: "Bilatzen ari zaren orria ez da existitzen edo mugitu egin da.",
    cta: "Hasierara itzuli",
  },
  common: {
    learnMore: "Gehiago jakin",
    getStarted: "Hasi",
  ...
  faqServicios: {
    ...
    items: [
      ...
      { q: "Mantentze-lana sartzen al da?", a: "Bai, lehen urte osoa: hostinga, domeinua, SSL, WhatsApp laguntza eta edukiaren aldaketak (testuak, argazkiak, prezioak, ordutegiak, zerbitzu berria…). Bigarren urtetik aurrera, mantentze-lana 600€/urteko da (50€/hilean inguru, urtean behin fakturatua)." },
      { q: "Edozein momentuan aldaketak eska ditzaket?", a: "Bai. Garapenean berrikuspen txandak doan dira. Abian jarri ondorengo lehen urtean, edukiaren aldaketak barne daude: WhatsAppera bidaltzen dizkidazu eta egiten ditut." },
      ...
      { q: "Weba nirea da?", a: "Bai. Domeinua zure izenean erregistratzen da lehen egunetik eta weba zurea da ordainketaren ondoren, ez duzu alokatzen. Zure Google fitxa eta iritziak ere zure negoziokoak dira. Urteko mantentze-lanak sarean eta zainduta edukitzeko balio du." },
    ],
  },
  faqPrecios: {
    title: "Prezioari buruzko galderak",
    items: [
      { q: "Zergatik ordainketa bakarra eta ez hileko kuota?", a: "Tokiko negozio gehienentzat weba behin egiten da eta gero atzeko planoan lan egiten du. Ez du zentzurik dagoeneko eginda dagoen zerbaitengatik hilero kuota bat ordaintzeak. Behin ordaintzen duzu, zurea da, eta mantentze-lana urtean behin bakarrik berritzen duzu." },
      { q: "Ezkutuko kosturik al dago?", a: "Ez. 1.300€ + BEZ barne sartzen dira diseinua, programazioa, domeinua, hostinga, SSL, Google Maps, iritzien sistema, WhatsApp laguntza eta edukiaren aldaketak lehen urtean. 2. urtetik aurrera, 600€/urteko mantentze-lana bakarrik." },
      ...
      { q: "Bigarren urtetik aurrera zer ordaintzen dut?", a: "600€/urteko (50€/hilean inguru, baina urtean behin fakturatua) weba sarean, domeinua zure izenean berrituta eta zure Google fitxa zainduta edukitzeko. Weba bizirik mantentzeko kostua da, zuk ezer tekniko egin behar izan gabe." },
