const en = {
  nav: {
    ...
    contacto: "Contact",
    consultaGratuita: "I want my website",
  },
  hero: {
    title: "More calls for your local business. For €1,300.",
    subtitle:
      "Your professional website, your Google Maps profile optimized and a system to collect reviews. One-off payment, first year included. 30-day money-back guarantee.",
    subtitlePre:
      "Your professional website, your Google Maps profile and a reviews system, for a one-off",
    subtitlePost: " + VAT, with the first year included.",
  ...
  services: {
    title: "Built for professional businesses with serious tickets.",
    subtitle:
      "Clinics, law firms, B2B industry, real estate, premium retail. If your customers compare online before picking up the phone, this system is for you.",
    localBusiness: {
      title: "Dental clinics, physio, aesthetics",
      description:
        "Patients compare 3 clinics before booking. Your site has to convey trust: real photos of the team and venue, clear info on services and prices, visible reviews, easy booking.",
    },
    clinic: {
      title: "Law firms and professional practices",
      description:
        "Lawyers, accountants, consultants, engineering firms. High-ticket services where clients compare online before picking up the phone. Serious site, clear practice areas, visible team and qualified contact form that filters the good leads.",
    },
    multilingual: {
      title: "Industry and B2B technical services",
      description:
        "Small industrial companies and B2B suppliers in Basque Country and Navarra industrial estates. Whoever decides the purchase compares catalogues at night from a phone. You need a serious site that conveys technical capability, a clear services section, visible certifications and a quote form that filters real opportunities.",
    },
    redesign: {
      title: "Real estate and premium retail",
      description:
        "Real estate agencies, local insurers, optical, jewelry, interior design. Professionals with high tickets where brand image and local presence are your strongest assets. Site that conveys seriousness, up-to-date listings and qualified lead capture.",
    },
  ...
  pricing: {
    title: "Your website: €1,300, first year included",
    subtitle:
      "One-off payment, plus VAT. First year of maintenance included. 30-day money-back guarantee. The site is yours.",
    from: "One-off",
    month: "+ VAT",
    popular: "First year included",
    cta: "I want my website",
    ctaContact: "Request audit",
    notePrice:
      "A single payment, with the first year of maintenance included. From year 2, €600/year (around €50/month, billed once a year) to keep it online and looked after. The domain is yours from day one.",
    plans: [
      {
        ...
        price: "€1,300",
        description:
          "One-off payment + VAT, with the first year of maintenance included. 30-day money-back guarantee. Everything: design, hosting, domain, Google Maps, reviews and WhatsApp support. The site is yours, with no monthly fees.",
        features: [
          ...
          "Domain, hosting, support and changes included the first year",
        ],
      },
    ],
  },
  ...
  footer: {
    tagline: "Where aesthetics meets function.",
    links: {
      company: "Company",
      services: "Services",
      legal: "Legal",
  ...
  faqServicios: {
    ...
    items: [
      { q: "How fast is the website ready?", a: "In a week from closing the payment. We start straight away." },
  ...
  faqPrecios: {
    ...
    items: [
      { q: "Why a one-off payment and not a monthly fee?", a: "For most local businesses the website is built once and then works in the background. There's no point paying a fee every month for something that's already done. You pay once, you own it, and you only renew the maintenance once a year." },
      { q: "Are there hidden costs?", a: "No. €1,300 + VAT covers design, development, domain, hosting, SSL, Google Maps, reviews system, WhatsApp support and content changes during the first year. From year 2, just the €600/year maintenance. No extra invoices." },
      { q: "What if I'm not convinced by the result?", a: "You have 30 days from launch to ask for a full refund, no explanation required." },
      { q: "From the second year, what do I pay?", a: "€600/year (around €50/month, but billed once a year) to keep the site online, the domain renewed in your name and your Google profile looked after. It's what it costs to keep the site alive, without you handling anything technical." },
