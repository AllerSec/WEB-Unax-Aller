    ...
    return [
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Buyout from the monthly plan anytime", on: true },
        ],
    ...
    return [
      ...
      },
      {
        ...
        features: [
          ...
          { label: "Hileko planetik erostea edozein unetan", on: true },
        ],
  ...
  return [
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Opción de compra desde el plan mensual", on: true },
      ],
