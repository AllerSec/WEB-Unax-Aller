...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    ...
    fr: "Créateur de site web freelance pour les conserveries, l'hôtellerie-restauration maritime et les entreprises de pêche de Bermeo. Sites sur mesure avec SEO local. Paiement unique de 1 300 € + TVA, première année incluse.",
  };
