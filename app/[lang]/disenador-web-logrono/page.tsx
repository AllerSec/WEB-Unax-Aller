...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    ...
    fr: "Créateur de site web freelance pour les caves à vin, l'hôtellerie-restauration et les entreprises de Logroño et de La Rioja. Sites sur mesure avec SEO local. Paiement unique de 1 300 € + TVA, première année incluse.",
  };
