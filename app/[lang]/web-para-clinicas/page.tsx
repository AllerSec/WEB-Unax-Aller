...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    es: `Diseñador web freelance especializado en ${name}. Webs a medida con SEO local, Google Maps y reseñas para conseguir más pacientes. 0€ inicial, 149€/mes.`,
    en: `Freelance web designer specialised in ${name}. Custom websites with local SEO, Google Maps and reviews to win more patients. €0 upfront, €149/month.`,
    eu: `${name}etan espezializatutako web diseinatzaile freelancea. Neurrizko webguneak tokiko SEO, Google Maps eta iritziekin paziente gehiago lortzeko. 0€ hasieran, 149€/hil.`,
  };
  return {
    title: titles[locale],
