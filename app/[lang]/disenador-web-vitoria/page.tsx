...
const SLUG = "disenador-web-vitoria";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    ...
    en: "Freelance web designer for businesses in Vitoria-Gasteiz and Álava. Custom websites with local SEO, premium design and performance. One-off €1,300 + VAT, first year included.",
    eu: "Web diseinatzaile freelance Gasteiz eta Arabako negozioetarako. Neurrizko webguneak SEO lokalarekin. 1.300€ + BEZ ordainketa bakarra, lehen urtea barne.",
    fr: "Créateur de site web freelance pour les entreprises de Vitoria-Gasteiz et d'Alava. Sites sur mesure avec SEO local, design premium et performance. Paiement unique de 1 300 € + TVA, première année incluse.",
  };
