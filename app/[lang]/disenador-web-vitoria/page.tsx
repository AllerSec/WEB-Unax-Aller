...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    es: "Diseñador web freelance para negocios de Vitoria-Gasteiz y Álava. Webs a medida con SEO local, diseño premium y rendimiento. Sin pagar nada al empezar: 0€ inicial y 149€/mes.",
    en: "Freelance web designer for businesses in Vitoria-Gasteiz and Álava. Custom websites with local SEO, premium design and performance. No upfront cost: €0 to sign, €149/month.",
    eu: "Web diseinatzaile freelance Gasteiz eta Arabako negozioetarako. Neurrizko webguneak SEO lokalarekin. Hasieran ezer ordaindu gabe: 0€ eta 149€/hil.",
  };
