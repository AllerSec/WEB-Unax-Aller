...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    es: "Diseñador web freelance para negocios de Bilbao y Bizkaia. Webs a medida con SEO local, diseño premium y rendimiento. Sin pagar nada al empezar: 0€ inicial y 149€/mes.",
    en: "Freelance web designer for businesses in Bilbao and Bizkaia. Custom websites with local SEO, premium design and performance. No upfront cost: €0 to sign, €149/month.",
    eu: "Web diseinatzaile freelance Bilbo eta Bizkaiko negozioetarako. Neurrizko webguneak SEO lokalarekin, diseinu premiuma eta errendimenduarekin. Hasieran ezer ordaindu gabe: 0€ eta 149€/hil.",
  };
