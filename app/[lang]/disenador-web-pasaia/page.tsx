...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptions: Record<string, string> = {
    es: "Diseñador web freelance para empresas portuarias, hostelería y comercio de Pasaia. Webs a medida con SEO local. Desde 1.500€ IVA incluido.",
    en: "Freelance web designer for port companies, hospitality and retail in Pasaia. Custom websites with local SEO. From €1,500 VAT included.",
    eu: "Web diseinatzaile freelance Pasaiako portu-enpresa, ostalaritza eta merkataritzarentzat. Neurrizko webguneak SEO lokalarekin. 1.500€-tik BEZ barne.",
  };
