...
const COPY = {
  es: {
    ...
    titleA: "Las llamadas de",
    titleHighlight1: "tu ciudad",
    titleB: "se las lleva",
    titleHighlight2: "quien sale primero",
  ...
  en: {
    ...
    titleB: "go to",
    titleHighlight2: "whoever ranks first",
    titleC: "And most don't even know it.",
  ...
  eu: {
    ...
    titleA: "Zure hiriko deiak",
    titleHighlight1: "lehenengo agertzen denak",
    titleB: "eramaten ditu",
    titleHighlight2: "eta zuk ez",
